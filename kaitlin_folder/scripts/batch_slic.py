...
path_to_results_folder ="/N/project/laidel_el_mcv/LAIDEL-MRI-tumor-id/results/slic_classified/"
...
def loop_body(folder_path):
  ...
  if folder_path.is_file() == False:
    ...
    #create folder with data ID in results folder 
    #path_to_results = path_to_results_folder+str(data_id)+'/'
    #os.system('mkdir '+path_to_results )
