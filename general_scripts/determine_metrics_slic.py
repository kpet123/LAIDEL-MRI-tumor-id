...
path_to_yhat_folder ="/N/project/laidel_el_mcv/LAIDEL-MRI-tumor-id/results/slic_classified" +"/"

#Path to results folder to store metatdata. TODO: CHANGE TH
output_path ="/N/project/laidel_el_mcv/LAIDEL-MRI-tumor-id/results/metrics_csvs/slic_metrics.csv"
