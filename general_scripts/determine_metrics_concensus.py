...
path_to_yhat_folder ="/N/project/laidel_el_mcv/LAIDEL-MRI-tumor-id/results/consensus_kmeans_slic_classified" +"/"

#Path to csv file to store metatdata. TODO: CHANGE TH
output_path ="/N/project/laidel_el_mcv/LAIDEL-MRI-tumor-id/results/metrics_csvs/consensus_kmeans_slic"
